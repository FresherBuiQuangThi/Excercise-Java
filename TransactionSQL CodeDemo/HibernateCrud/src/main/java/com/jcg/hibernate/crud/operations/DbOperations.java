...
public class DbOperations {
	...
	public static void createRecord() {
		...
		try {
			...
			for(int j = 101; j <= 105; j++) {
				...
				studentObj.setStudentName("Bui Quang Thi " + j);
				studentObj.setCourse("Cong Nghe Thong Tin");	
	...
	// Method 3: Update student in Database
	public static void updateRecord(int student_id) {		
		try {
			...
			stuObj.setStudentName("Bui Quang Thien");
			stuObj.setCourse("Cu nhan Kinh Te");
	...
	// Method 4(a): Delete Student in Database
	...
	// Method 4(b): Find Student for id_Student
	...
	// Method 5: Delete all Student in Database
